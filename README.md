...
### 1. Landing and entry
The landing page introduces the product and routes the user into the main training experience.
...
VITE_API_URL=https://nivine.onrender.com
VITE_BACKEND_API_URL=https://nivine.onrender.com
```
