    ...
    <div className="animate-in fade-in duration-1000">
      <div className="text-center mb-12 space-y-6 flex flex-col items-center">
        ...
        <p className="text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
          Configure personality, tone, language, and challenge level in a dedicated custom coach workflow. Premium includes 120 minutes of custom coach calls each month, plus 30 neural module calls (10 mins each), quizzes, and leaderboards.
        </p>
      </div>
